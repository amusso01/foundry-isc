		...
		<div class="hero_carousel-swiper">
			...
			<div id="swiperBanner" class="swiper-container banner-swiper">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide first-home-corrousel" style="background-image:url(<?php echo get_the_post_thumbnail_url( get_the_ID() , 'full' ) ?>)">
								<div class="hero-carousel__content">
									<div class="hero-carousel__content-inner">	
										<div class="tag__wrapper"> </div>
										<h2><?php the_title(); ?></h2>
									
										<div class="btn__wrapper"><a href="<?php echo get_the_permalink(111428) ?>" class="btn">Join us</a></div>
									</div>
								</div>
								<div class="hero-carousel__image"  >
										
										<div class="carousel-mobile">
											<div class="hero-carousel__content-inner-mobile">	</div>
							...
							<div class="swiper-slide" >
								<div class="hero-carousel__content">
									...
									<?php foreach($term as $key => $cat) :?>
										...
										<p class="tag <?php echo $key == 100 ? 'tag-light' : '' ?>"><?php echo $cat->name?></p>
									
									<?php endforeach; ?>
									</div>
									<h2><?php echo $article->post_title ?></h2>
									
									<div class="btn__wrapper"><a href="<?php echo get_the_permalink($article->ID) ?>" class="btn">Read more</a></div>
									</div>
								</div>
